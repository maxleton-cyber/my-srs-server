...
![](http://ossrs.net/gif/v1/sls.gif?site=github.com&path=/tmpl/k8s/kubernetes/maxleton-cyber/my-srs-server)
[![](https://github.com/maxleton-cyber/my-srs-server/actions/workflows/kubernetes.yml/badge.svg)](https://github.com/maxleton-cyber/my-srs-server/actions/workflows/kubernetes.yml)
...
**Step 2:** Click the <kbd>Use this template</kbd> to create your repository, then set the [secrets](https://github.com/maxleton-cyber/my-srs-server/settings/secrets/actions):

* `KUBECONFIG` is the config of K8s, for example, the content of `cat $HOME/.kube/config`.

**Step 3:** Run workflow from [Actions](https://github.com/maxleton-cyber/my-srs-server/actions/workflows/kubernetes.yml) to deploy to your K8s, for example, if your external IP is `81.70.125.89`:
